...
class StreamElementsClient:
    def get_channel_info(channel_name: str) -> dict:
        ...
        response = requests.get(url, timeout=Commands.STREAM_ELEMENTS_TIMEOUT_SECONDS)
    ...
    def send_chat_command(self, channel_id: str, command: str) -> dict:
        ...
        response = requests.post(
            url, headers=headers, json=data, timeout=Commands.STREAM_ELEMENTS_TIMEOUT_SECONDS
        )
        return response.json()
