...
def response_error_embed(error_key: str, locale: str, footer: bool = False) -> discord.Embed:
    ...
    if footer:
        embed.set_footer(text=f"• {ml('commands.commands.setup.embed.footer', locale)}")
