...
class Trace:
    ...
    def supersede(self, journey: "Trace") -> None:
        ...
        journey.max_level = max(journey.max_level, self.max_level)
        journey.reported_event = journey.reported_event or self.reported_event
        journey.truncated += self.truncated
