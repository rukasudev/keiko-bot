...
from app.forms.adapters.discord import observability
from app.forms.adapters.discord.executor import Executor, Surface, expire_surface
from app.forms.adapters.discord.ids import decode
from app.forms.adapters.discord.interactions import to_event
from app.forms.adapters.discord.renderer import Dispatcher
...
from app.forms.engine.effects import Finalize, OpenChild, ResumeChild, ResumeParent
...
from app.forms.engine.store import InMemorySessionStore
from app.forms.extensions.copy import normalize_locale, text
...
class Runtime:
    ...
    def _close(self, session: FormSession, decision: Decision) -> None:
        ...
        finalize = next((e for e in decision.effects if isinstance(e, Finalize)), None)
        if (
