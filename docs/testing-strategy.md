...
| `app/forms/adapters/discord/layout.py` | `pytest tests/behavioral/golden -q` (the manager panel draws through it) + `tests/behavioral/contracts/test_setup_dashboard.py` |
